...
public class ConfigHelper {
    ...
    /**
     * Registers all provided configuration specs for this mod with the loader. Optionally places config files in a subfolder matching the mod ID.
     *
     * @param container the {@link ModContainer} of the mod
    ...
    public static void registerConfigs(ModContainer container, String modId, boolean withFolder, @Nullable ModConfigSpec serverConfig, @Nullable ModConfigSpec clientConfig,
            @Nullable ModConfigSpec commonConfig, @Nullable ModConfigSpec startupConfig) {
        String path = modId;
     ...
     *
     * <p>
     * This method returns {@code true} if either the MagmaCore debug mode is enabled or the mod-specific debug mode is passed as {@code true}.
     *
