...
public class EventUtils {
    ...
    /**
     * Applies a status effect and/or damage to a player or living entity. Only executes on the server
     * side.
     *
     ...
     * @param damageAmount the amount of damage to inflict; negative values deal magic damage,
     *     non-negative values inflict no damage
     */
