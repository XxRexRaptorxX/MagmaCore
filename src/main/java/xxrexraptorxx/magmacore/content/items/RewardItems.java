...
public class RewardItems {
    ...
    public static ItemStack getChestplate(Level level, Player player) {
        ...
        try {
            ...
            reward.set(DataComponents.LORE,
                    new ItemLore(List.of(Component.empty(), FormattingHelper.setCoreLangComponent("item", "legendary_chestplate.lore").append(player.getName().getString()))));
    ...
    public static ItemStack getLeggings(Level level, Player player) {
        ...
        try {
            ...
            reward.set(DataComponents.LORE,
                    new ItemLore(List.of(Component.empty(), FormattingHelper.setCoreLangComponent("item", "legendary_leggings.lore").append(player.getName().getString()))));
