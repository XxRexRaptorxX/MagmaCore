...
public class TagHelper {
    ...
    /**
     * Creates a {@link TagKey<Item>} for an item tag under the shared "c" namespace. Commonly used for cross-mod compatibility tags (e.g., "c:ingots/iron").
     *
     * @param name the path/name of the tag
    ...
    /**
     * Creates a {@link TagKey<Block>} for a block tag under the shared "c" namespace. Commonly used for cross-mod compatibility tags (e.g., "c:stone").
     *
     * @param name the path/name of the tag
